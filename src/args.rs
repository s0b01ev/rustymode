...
#[derive(Parser, Debug)]
#[clap(
    author = "Dmitry Sobolev <sobolev@gmail.com>, originally by Marco Radocchia <marco.radocchia@outlook.com>",
    version,
    about = "Fork of BombusCV: OpenCV-based motion detection/recording software for insect research.",
    long_about = None
)]
pub struct Args {
